...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_APP,  KC_UNDO, KC_CUT,   KC_COPY, KC_LBRC, KC_PASTE, BACK,    KC_RBRC, RALT(KC_5), XXXXXXX, KC_BSLS, _______, \
    ...
    _______, XXXXXXX, KC_BTN2, KC_BTN1, KC_LCTRL, XXXXXXX, XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, \
    _______, XXXXXXX, XXXXXXX, KC_BTN3, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, KC_WH_D, KC_WH_U, XXXXXXX, _______, \
                               _______, _______,  _______, _______, _______, _______ \
    )
};
