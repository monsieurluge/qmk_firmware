...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTRL, KC_Z, KC_X, KC_C,    KC_D,    KC_V,    KC_K,   KC_H,    KC_COMM, KC_DOT, KC_SLSH, KC_LALT, \
                          SP_LY03, SP_LY01, KC_LSFT, KC_SPC, SP_LY02, KC_LGUI \
    ),
    ...
    KC_LSFT, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______, KC_LGUI, \
                               KC_LCTRL, KC_SPC,  SP_LY01, KC_SPC,  SP_LY02, SP_LY03 \
    ),
    ...
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_PSCREEN, BACK,    KC_END,  KC_PGDN, KC_PGUP, XXXXXXX, _______, \
    ...
    _______, XXXXXXX, KC_BTN2, KC_BTN1, KC_LCTRL, XXXXXXX, BACK,    KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, \
    _______, XXXXXXX, XXXXXXX, KC_BTN3, XXXXXXX,  XXXXXXX, XXXXXXX, FORWARD, KC_WH_D, KC_WH_U, XXXXXXX, _______, \
                               _______, _______,  _______, _______, _______, _______ \
    )
};
...
layer_state_t layer_state_set_user(layer_state_t state) {
  return update_tri_layer_state(state, LY_FN1, LY_FN2, LY_FN4);
}
