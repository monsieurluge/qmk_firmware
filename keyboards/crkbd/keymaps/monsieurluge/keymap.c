...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LGUI, KC_Z, KC_X, KC_C,    KC_D,    KC_V,    KC_K,    KC_H,    KC_COMM, KC_DOT, KC_SLSH, KC_LALT, \
                         SP_LY03, KC_LSFT, SP_LY01, SP_SPSH, SP_LY02, KC_LCTRL \
    ),
    ...
    XXXXXXX, KC_Z, KC_X, KC_C,    KC_D,     KC_V,    KC_K,    KC_H,    KC_COMM, KC_DOT, KC_SLSH, KC_LALT, \
                         SP_LY03, KC_LCTRL, SP_LY01, SP_SPSH, SP_LY02, KC_LGUI \
    ),*/
    ...
    KC_APP,  XXXXXXX, XXXXXXX,  XXXXXXX, KC_LBRC, KC_ESC,  KC_TAB,  KC_RBRC, RALT(KC_5), XXXXXXX, KC_BSLS, _______, \
